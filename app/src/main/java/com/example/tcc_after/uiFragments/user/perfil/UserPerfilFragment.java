 ...
 */
public class UserPerfilFragment extends Fragment implements AdapterView.OnItemSelectedListener {
        ...
        call.enqueue(new Callback<List<Evento>>() {
            ...
            public void onResponse(Call<List<Evento>> call, Response<List<Evento>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    recyclerView.setAdapter(new UserPerfilFragment.EventoAdapter(list));
                }
            }
...
//            List<TipoEvento> listTiposEvento = new ArrayList<TipoEvento>();
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new UserPerfilFragment.EventoAdapter.EventoViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_event, parent, false));
        }
...
//            TipoEvento tipoEvento = this.listTiposEvento.get(position);
            ((UserPerfilFragment.EventoAdapter.EventoViewHolder) holder).setEventoData(evento);
